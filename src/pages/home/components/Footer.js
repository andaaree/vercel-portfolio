  ...
  return (
    <footer className="footer items-center mt-10 p-4 bg-neutral text-neutral-content">
      <aside className="items-center grid-flow-col">
        ...
        <p>Copyright <a rel='noreferrer' target='_blank' href="https://draxansh.my.id">Draxan Software House</a> © 2024 - All right reserved</p>
      </aside> 
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a target='blank' rel='noreferrer' className='link link-hover' href='https://instagram.com/andaaree'><IgIcon /></a>
        <a target='blank' rel='noreferrer' className='link link-hover' href='https://linkedin.com/in/andaaree/'><LinkedIcon /></a>
        <a target='blank' rel='noreferrer' className='link link-hover' href='https://wa.me/6285186662206?text=Hi%2C%20I%27m%20contacting%20you%20from%20your%20website%20portfolio'><WAIcon /></a>
      </nav>
    </footer>
  );
};
